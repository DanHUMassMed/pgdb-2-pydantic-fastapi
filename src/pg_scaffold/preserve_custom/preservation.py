...
class CodePreservationManager:
    ...
    def preserve_custom_code(self) -> Dict[str, PreservedCode]:
        ...
        python_files = self.find_python_files(self.source_directory)
        self.logger.info(f"Scanning {len(python_files)} Python files for custom code...")
    ...
    def restore_custom_code(self, preserved_code: Dict[str, PreservedCode]) -> int:
        ...
        updated_count = 0
        python_files = self.find_python_files(self.target_directory)
    ...
    def write_code(rendered: str, output_dir: str, file_name: str) -> None:
        ...
        header = f"# Generated by pg-scaffolding {timestamp}\n"
        
        # Preservation markers
        preserve_start = "#-- Preserve Custom code START --#\n"
        preserve_end = "#-- Preserve Custom code END   --#\n"
